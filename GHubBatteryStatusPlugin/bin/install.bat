...
SET OUTPUT_DIR="D:\Stream Deck Plugins\GHubBatteryStatusPlugin\GHubBatteryStatusPlugin\bin\TEMP"
SET DISTRIBUTION_TOOL="D:\Stream Deck Distribution\DistributionTool.exe"
